...
class History extends \Opencart\System\Engine\Controller {
	...
	protected function getList() {
		...
		$data += oc_transaction_summary($this->model_aeps_history, $filter_data);
		...
		$data['sort_custmerid'] = $this->url->link('aeps/history', 'user_token=' . $this->session->data['user_token'] . '&sort=p.customerid' . $sort_url, true);
		$data['sort_aepsid']    = $this->url->link('aeps/history', 'user_token=' . $this->session->data['user_token'] . '&sort=p.aepsid' . $sort_url, true);
		$data['sort_created']   = $this->url->link('aeps/history', 'user_token=' . $this->session->data['user_token'] . '&sort=p.created' . $sort_url, true);
		$data['sort_status']    = $this->url->link('aeps/history', 'user_token=' . $this->session->data['user_token'] . '&sort=p.status' . $sort_url, true);
		...
		$data['pagination'] = $this->load->controller('common/pagination', [
			...
			'page'  => $page,
			'limit' => $limit,
			'url'   => $this->url->link('aeps/history', 'user_token=' . $this->session->data['user_token'] . $page_url . '&page={page}')
		]);
