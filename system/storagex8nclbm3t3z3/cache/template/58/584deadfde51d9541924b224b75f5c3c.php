...
/* admin/view/template/sale/wholesale.twig */
class __TwigTemplate_49548e5f43181e3cb9a505967452bf00 extends Template
{
...
if (filterBtn) {
    filterBtn.addEventListener('click', function () {
        ...
        // 1️⃣ Show loading text immediately
        const tbody = document.getElementById('salesprice-data');
        if (tbody) {
            tbody.innerHTML = '<tr><td colspan=\"17\" class=\"text-center\">Loading...</td></tr>';
        }

        // Reset page
        currentPage.salesprice = 1;
        setTimeout(() => {
            loadTabData('salesprice');
        }, 300); // 
    });
...
if (downloadBtn) {
    downloadBtn.addEventListener('click', function () {
        ...
        let url = 'index.php?route=sale/wholesale.exportExcel'
            + '&user_token=' + USER_TOKEN
            + '&tab=salesprice';

        // ✅ If filter applied → export filtered data
        if (dateAdded) {
...
document.getElementById('button-download-total')?.addEventListener('click', function () {
    ...
    if (exportBtn) {
        exportBtn.addEventListener('click', function() {
            ...
            let url = 'index.php?route=sale/wholesale.export&user_token=' + USER_TOKEN + '&tab=' + currentTab;
...
function loadTabData(tabName, page) {
    ...
    const endpoints = {
        salesprice:   'sale/wholesale.getSalesPriceData',
        salesbyorder: 'sale/wholesale.getSalesByOrderData',
        salesbyproduct:'sale/wholesale.getSalesByProductData',
        salesbynumber:'sale/wholesale.getSalesByNumberData',
        salesbyseller:'sale/wholesale.getSalesBySellerData',
        salesbytotal: 'sale/wholesale.getSalesByTotalData',
        salesbycoupon: 'sale/wholesale.getSalesByCouponData'
    };
...
function renderPagination(tabName, total, page, limit) {
    ...
    if (page > 1) {
        html += '<li><a href=\"#\" onclick=\"loadTabData(\\'' + tabName + '\\', ' + (page - 1) + '); return false;\">«</a></li>';
    }
...
function openCustomerHistory(phone) {
    ...
    fetch('index.php?route=sale/wholesale.getCustomerOrderHistory'
        + '&user_token=' + USER_TOKEN
        + '&phone=' + phone)
    .then(res => res.json())
    .then(data => {
...
";
    ...
    {
        return "admin/view/template/sale/wholesale.twig";
    }
    ...
    {
        return array (  1269 => 1213,  725 => 672,  563 => 512,  561 => 511,  559 => 510,  553 => 505,  522 => 476,  429 => 385,  42 => 1,);
    }
...
{{ footer }}", "admin/view/template/sale/wholesale.twig", "/home/k5ahkheh1fv2/public_html/JEWELLERY/admin/view/template/sale/wholesale.twig");
    }
}
