...
class __TwigTemplate_c19598ddd9b044a1258dce647b05bb1e extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        $macros = $this->macros;
        // line 1
        yield "<footer id=\"footer\" style= padding:20px;>";
...
";
    ...
    {
        return new Source("<footer id=\"footer\" style= padding:20px;>{{ text_footer }}<br/>{{ text_version }}</footer></div>
<script src=\"{{ bootstrap }}\" type=\"text/javascript\"></script>
</body></html>
", "admin/view/template/common/footer.twig", "/home/k5ahkheh1fv2/public_html/JEWELLERY/admin/view/template/common/footer.twig");
    }
}
